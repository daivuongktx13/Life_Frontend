<template>
  <div class="flex flex-col md:flex-row py-3 border static md:sticky top-0 z-10 bg-white/80 shadow-md">
    <div class="basis-1/2 md:pl-5 text-xl font-bold md:font-semibold">
      <a
        class="inline-flex pl-3 p-1 text-2xl cursor-pointer"
        href="/"
        style="font-family: 'Dancing Script', cursive;"
      >Life</a>
      <!-- <button id="trigger-nav"></button> -->
      <button
        id="trigger-nav"
        type="button"
        class="float-right transition-all inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
      >
    ...
    <div
      id="mobile-menu"
      class="hidden md:block basis-1/2 transition-all"
    >
      <div
        class="basis-1/2 flex flex-col md:flex-row justify-end space-y-0 md:space-x-8 text-xl items-center md:pr-10
      ...
      > 
        ...
        <div
          class="hover:text-sky-500 transition"
          :class="{active: getActive('about')}"
        ><a href="#about">About</a></div>
        <button
          class="from-violet-500 to-cyan-600 bg-gradient-to-r 
